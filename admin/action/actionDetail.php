    ...
    <div class="container main-det mt-4">
        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
            ...
            <div class="event-detail">
                <img width="500px" src="../../assets/images/banner/<?= $row['event_banner'] ?>" alt="">
                ...
                <h3 style="margin-top: 20px;">Seat available</h3>
                <p>Seat A : Rp. <?= $row['seat_A'] ?> </p>
                <p>Seat B : Rp. <?= $row['seat_B'] ?></p>
                <p>Seat C : Rp. <?= $row['seat_C'] ?></p>
                <p>Seat D : Rp. <?= $row['seat_D'] ?></p>
            </div>
